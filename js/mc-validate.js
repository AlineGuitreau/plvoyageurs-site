...
(function($) {
	...
	try {
	    ...
	    err_style = '#mc_embed_signup input.mce_inline_error { border-color:#6B0505; } #mc_embed_signup div.mce_inline_error { background-color:#fff; font-weight: bold; z-index: 1; color:##a94442; }';
	}
